...
import 'package:cuidados_fibrilacao_atrial/utils/color_extensions.dart';
import 'package:provider/provider.dart';

class HistoricoExamesScreen3 extends StatefulWidget {
  ...
  const HistoricoExamesScreen3({Key? key, this.paciente}) : super(key: key);

  @override
  State<StatefulWidget> createState() => HistoricoExamesScreen3State();
}

class HistoricoExamesScreen3State extends State<HistoricoExamesScreen3> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'Histórico de resultados limite máximo(${Utils.valorExameAlto})',
                    style: const TextStyle(
  ...
  List<BarChartGroupData> showingGroups(List<Exame> lista) => List.generate(7, (i) {
    switch (i) {
      case 0:
  ...
  List<BarChartGroupData> showingGroups2(List<Exame> lista) => lista.map<BarChartGroupData>((exame) =>
      makeGroupData(exame.id!, exame.valor!.toDouble(),isTouched: exame.id! == touchedIndex))
      .toList();
  List<BarChartGroupData> showingGroups3(List<Exame> lista){
    List<BarChartGroupData> retorno = [];
    int i = 0;
    lista.forEach((element) {
      datas.add(Utils.epochToDiaMes(element.data!));
      retorno.add(makeGroupData(i, element.valor!.toDouble(),isTouched: i == touchedIndex,barColor: element.valor! > Utils.valorExameAlto ? Colors.red : Colors.white));
      i++;
  ...
  BarChartData mainBarData(List<Exame> lista) {
    return BarChartData(
      barTouchData: BarTouchData(
        touchTooltipData: BarTouchTooltipData(
            ...
            getTooltipItem: (group, groupIndex, rod, rodIndex) {
              String weekDay;
              weekDay = Utils.epochToString(lista[groupIndex].data!);
      ...
      barGroups: showingGroups3(lista),
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    Widget text = Text(datas[value.toInt()].toString(), style: style);
