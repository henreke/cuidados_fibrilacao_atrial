        ...
        child: Column(
          ...
          children:  [
            ...
            Padding(
              ...
              child: Text('Palpitação no coração',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Falta de Ar ao esforço',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),textAlign: TextAlign.center,),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fraqueza e/ou Fadiga',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Tontura',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Desmaio',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Ansiedade',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Dor no peito',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),

            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Apneia Obstrutiva do Sono',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),

            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Estresse',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),

            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Hábitos de vida inadequados',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
