      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children:  [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('${Text('Atenção:',style: TextStyle(fontSize: 26,fontWeight: FontWeight.w800))} Sempre informe à equipe de saúde sobre todos os medicamentos, suplementos que você está tomando antes de iniciar ou modificar o tratamento com anticoagulantes.',
                style: TextStyle(fontSize: 24,fontWeight: FontWeight.w500),
                textAlign: TextAlign.justify,
              ),
            ),
