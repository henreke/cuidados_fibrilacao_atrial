        ...
        child: Column(
          ...
          children:  [
            ...
            const Padding(
                ...
                child: Text('Fibrilação paroxística',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800),),
            ),
            const Padding(
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação persistente ',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800),),
            ),
            const Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação de longa duração',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800),),
            ),
            const Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação permanente',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800),),
            ),
            const Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação não valvular',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w800),),
            ),
            const Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
