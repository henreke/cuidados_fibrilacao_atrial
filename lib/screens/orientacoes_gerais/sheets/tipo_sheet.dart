        ...
        child: Column(
          ...
          children:  [
            Center(
              child: Card(
                ...
                child: const Padding(
                  ...
                  child: Text('Quais os tipos de Fibrilação Atrial?',style: TextStyle(fontSize: 24,color: Colors.white)),
                ),
              ),
            ),
            ...
            Padding(
                ...
                child: Text('Fibrilação paroxística',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação persistente ',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação de longa duração',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação permanente',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
            ...
            Padding(
              padding: EdgeInsets.only(left: 25,right: 25,top: 10),
              child: Text('Fibrilação não valvular',style: TextStyle(fontSize: Utils.font_textos,fontWeight: FontWeight.w800),),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25.0,right: 25.0,top: 8),
